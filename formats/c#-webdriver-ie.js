/*
 * Formatter for C# / WebDriver / Explorer client.
 */
...
this.options = {
  ...
  header:
      'using System;\n' +
          ...
          '    [TestFixture]\n' +
          '    [Category("${category}")]\n' +
          '    public class ${className}Explorer: ${baseclass}\n' +
          '    {\n' +
          '        [SetUp]\n' +
          '        public void SetupTest()\n' +
          '        {\n' +
          '            InternalSetup(new InternetExplorerDriver());\n' +
          '        }\n' +
          '        \n' +
          '        [TearDown]\n' +
...
this.name = "C# (WebDriver) / Explorer";
